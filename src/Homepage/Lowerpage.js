...
export default function Lowerpage(){
    ...
    return(
        ...
        <div className="firstdiv">
                ...
                <div>
                    <img src={require('./jaiportfolio.jpg')} alt="" className="image-hover"/></div>
                <div style={{ textAlign: "left", marginLeft: "100px" }}> <button type="button" className="btn" onClick={handleResumeClick} >
                    View Resume
                </button></div>
            </div>
